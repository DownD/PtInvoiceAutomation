...
def main():
    ...
    parser = argparse.ArgumentParser(description='Dumps QR invoices from local files, it supports PDF and image files.')
    parser.add_argument('-f','--file', type=str, help='The file to read.')
    parser.add_argument('-d','--directory', type=str, help='The directory to read.')
